...
<>   
  <div className="topnav">
      ...
      <ul><Link href='../user-pages/community' className="ul">Community</Link></ul>
      <ul><Link href='../user-pages/profile' className="ul">Profile</Link></ul>
      <ul><Link href='../user-pages/cart'className="ul">Cart</Link></ul>
